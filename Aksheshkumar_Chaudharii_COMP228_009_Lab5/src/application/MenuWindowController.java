...
public class MenuWindowController implements Initializable
{
	...
	public void initialize(URL arg0, ResourceBundle arg1) 
	{
		...
		if(ticketCounts < 3) 
		{
			this.queries.addMovie("Inox", "Warden", "Dumb & Dumber", Integer.toString(250), 5, "8.00 AM");
			this.queries.addMovie("3D", "Brampton", "IP Man", Integer.toString(120), 7, "8:45 PM");
			this.queries.addMovie("Cineplex", "Pape", "The Raid Redmption", Integer.toString(222), 3, "11:00 PM");
			this.queries.addMovie("Cinestarz", "Bloor Yonge", "12 Years a Slave", Integer.toString(659), 20, "11.00 AM");
